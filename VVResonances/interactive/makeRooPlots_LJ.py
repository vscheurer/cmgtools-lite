...
plotter.addContribution("topW",False," t#bar{t} (W)",2,1,ROOT.kBlack,1001,ROOT.kTeal-1)
...
plotter.addContribution("topOther",False,"t#bar{t} (other)",2,1,ROOT.kBlack,1001,ROOT.kSpring-5,"_opt")
...
#    for p in ['HP','LP']:
#        for c in ['nob','b']:
#            plotter.drawStack("MJ","m_{j} [GeV]",c+"_"+l+"_"+p+"_13TeV")
#            plotter.canvas.SaveAs("postfitMJJ"+c+"_"+l+"_"+p+".png")
#            plotter.drawStack("MLNuJ","m_{VV} [GeV]",c+"_"+l+"_"+p+"_13TeV")
