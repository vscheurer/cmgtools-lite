...
#            card.addHistoShapeFromFile("nonRes",["MLNuJ","MJ"],rootFile,"histo",['OPTX:CMS_VV_LNuJ_nonRes_OPTX_'+qcdTag,'PTX:CMS_VV_LNuJ_nonRes_PTX_'+qcdTag,'PTX2:CMS_VV_LNuJ_nonRes_PTX2_'+qcdTag,'PTY:CMS_VV_LNuJ_nonRes_PTY_'+qcdTag,'OPTY:CMS_VV_LNuJ_nonRes_OPTY_'+qcdTag],False,0)        
            ...
            card.addHistoShapeFromFile("nonRes",["MLNuJ","MJ"],rootFile,"histo",['ScaleX:CMS_VV_LNuJ_nonRes_ScaleX_'+qcdTag,'ResX:CMS_VV_LNuJ_nonRes_ResX_'+qcdTag,'OPTY:CMS_VV_LNuJ_nonRes_OPTY_'+qcdTag,'PTY:CMS_VV_LNuJ_nonRes_PTY_'+qcdTag],False,0)        
            ...
            #Wjet
            card.addMJJTopMergedParametricShape("mjjRes","MJ","LNuJJ_MJJ_resW_"+purity+".json",{'CMS_scale_prunedj':1},{'CMS_res_prunedj':1.0},{'CMS_VV_topPt_0_'+lepton+"_"+category:1,'CMS_VV_topPt_1_'+lepton+"_"+category:"1.0/MH^2"},"MLNuJ")   
...
#                card.addSystematic("CMS_VV_LNuJ_vbf_intercategory","lnN",{'XWW':0.95,'XWZ':0.95})
            ...
            card.addSystematic('CMS_VV_topPt_0_'+lepton+"_"+category,"param",[0.0,0.2])
            card.addSystematic('CMS_VV_topPt_1_'+lepton+"_"+category,"param",[0.0,25000])
