...
#            card.addHistoShapeFromFile("nonRes",["MLNuJ","MJ"],rootFile,"histo",['PTX:CMS_VV_LNuJ_nonRes_PTX_'+qcdTag,'PTY:CMS_VV_LNuJ_nonRes_PTY_'+qcdTag],False,0)       

            card.addHistoShapeFromFile("nonRes",["MLNuJ","MJ"],rootFile,"histo",['ScaleY:CMS_VV_LNuJ_nonRes_ScaleY_'+qcdTag,'PTX:CMS_VV_LNuJ_nonRes_PTX_'+qcdTag,'PTY:CMS_VV_LNuJ_nonRes_PTY_'+qcdTag,'ScaleX:CMS_VV_LNuJ_nonRes_ScaleX_'+qcdTag],False,0)       
...
#            card.addHistoShapeFromFile("resW_MVV",["MLNuJ"],rootFile,"histo",['Scale:CMS_VV_LNuJ_resW_Scale_'+resWTag,'Res:CMS_VV_LNuJ_resW_Res_'+resWTag],False,0)       
            card.addHistoShapeFromFile("resW_MVV",["MLNuJ"],rootFile,"histo",['Scale:CMS_VV_LNuJ_resW_Scale_'+resWTag,'PT:CMS_VV_LNuJ_resW_PT_'+resWTag],False,0)       
            ...
            card.addSystematic("CMS_VV_LNuJ_nonRes_ScaleY_"+qcdTag,"param",[0.0,0.333])
            card.addSystematic("CMS_VV_LNuJ_nonRes_ScaleX_"+qcdTag,"param",[0.0,0.5])
